    ...
    <div className=" mx-auto mt-8 flex max-w-3xl flex-col gap-10 ">
      ...
      <div className="relative -mt-6 overflow-hidden py-8 opacity-90">
        <div className=" mt-2 flex flex-col  gap-10 md:flex-row">
          <p className="shrink-0 basis-[40%]  self-start border-s-2  border-green-600 pl-4 text-lg font-semibold tracking-wide ">
            Lets unravel the mechanics behind Dual Nationals
          </p>
          <p className="leading-relaxed  sm:max-w-md  lg:max-w-xl">
      ...
      <div className="relative -mt-6 overflow-hidden py-8 opacity-90">
        <div className=" mt-2 flex flex-col  gap-10 md:flex-row">
          <p className="shrink-0 basis-[40%]  self-start border-s-2  border-blue-600 pl-4 text-lg font-semibold tracking-wide ">
