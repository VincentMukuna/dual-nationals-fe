...
export const tagVariants = cva(
  'transition-all  inline-flex items-center text-sm pl-3 rounded-xl  dark:bg-slate-800 shadow overflow-hidden',
  {
    variants: {
      variant: {
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className={cn('h-full rounded-none px-3 py-1 hover:bg-transparent')}
      >
        <X size={14} />
      </Button>
    </span>
